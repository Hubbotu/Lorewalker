...
L["CONFIG_DIALOGUE_FRAME"] = "Окно диалогов"
L["CONFIG_DIALOGUE_THEME"] = "Тема оформления"
L["CONFIG_DIALOGUE_THEME_LIGHT"] = "Светлая"
L["CONFIG_DIALOGUE_THEME_DARK"] = "Темная"
L["CONFIG_DIALOGUE_RIGHTCLICKTOCLOSE"] = "Закрытие правым кликом"
L["CONFIG_DIALOGUE_FORCEGOSSIP"] = "Показывать скрытый флуд"
