...
local IsQuestFailedByQuestID = C_QuestLog.IsFailed or False
local IsQuestTrivialByQuestID = C_QuestLog.IsQuestTrivial or False
local IsQuestRepeatableByQuestID = C_QuestLog.IsRepeatableQuest or False
local IsQuestImportantByQuestID = C_QuestLog.IsImportantQuest or False
local GetQuestClassificationByQuestID = C_QuestInfoSystem.GetQuestClassification or Nil
...
local CanQuestHaveWarModeBonus = C_QuestLog.QuestCanHaveWarModeBonus or False
local IsAccountQuestByQuestID = C_QuestLog.IsAccountQuest or False
...
local GetQuestDetailsTheme = C_QuestLog.GetQuestDetailsTheme or Nil
...
do --Quest Info
    ...
    function ControlCenter_DataProvider.BuildFullQuestInfoFromCurrentQuest()
        ...
        QuestInfoBuffer.questName = GetTitleText() or ""
